...
| [`orx/standalone-space-root-execution`](https://github.com/MachineLearning-Nerd/icml26-repro-82Wosp2Iu1-asymptotic-optimality-of-the-high-dimensional-gaussian-mechanism-and-improve/tree/orx/standalone-space-root-execution) | Make the same audit executable from a downloaded Space root | `uv run --frozen python repro/src/verify.py` | 15/15 passed; both GitHub and standalone Space-root audits pass; supersedes Space revision `810a2254` | HF `cpu-upgrade`, 8 vCPU allocation, 8 workers |
